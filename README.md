...
Run a single command to produce CSV reports, a branded HTML assessment report, and an XLSX compliance matrix covering identity, email, security, devices, collaboration, and compliance baselines. **62 automated security checks** mapped across **13 compliance frameworks**.
...
M365-Assess/
  ...
  controls/                       # Control registry and framework mappings
    registry.json                 # Master registry (156 entries, 62 automated)
