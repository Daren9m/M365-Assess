@{
    ...
    PrivateData       = @{
        PSData = @{
            ...
            ReleaseNotes = 'v0.9.2 - Compliance UX: unified dual-metric cards, section filter, expand/collapse all, NIST 800-53 baseline profiles (Low/Moderate/High/Privacy)'
        }
    }
}
